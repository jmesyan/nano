...
type YlyShopOrder struct {
	...
	Channel  int     `xorm:"not null default 0 comment('支付渠道 0-所有 >1其他苹果') INT(5)" json:"channel" form:"channel" csv:"channel"`
	...
	Money    float32 `xorm:"not null default 0 comment('最终购买价格') FLOAT" json:"money" form:"money" csv:"money"`
