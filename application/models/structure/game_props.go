...
type GameProps struct {
	...
	Type      int    `xorm:"not null default 0 comment('道具类型 1-货币道具 2-经验材料 3-特效装备 4-人物体验卡 5-突破材料 6-改名卡 7-随机道具 8-表情 9-bgm 10-头像框 11-人物角色卡 12-头像') index INT(5)" json:"type" form:"type" csv:"type"`
	Subtype   int    `xorm:"not null default 0 comment('道具子类型 0-通用 1-出牌特效 2-结算特效 3-终结特效 4-牌背 5-桌布') TINYINT(3)" json:"subtype" form:"subtype" csv:"subtype"`
